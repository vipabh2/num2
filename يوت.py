...
YDL_OPTIONS={'format':'bestaudio[ext=m4a]/bestaudio/best','outtmpl':'downloads/%(title).50s.%(ext)s','noplaylist':True,'quiet':True,'cookiefile':f"{COOKIES_FILE}",'postprocessors':[{'key':'FFmpegExtractAudio','preferredcodec':'mp3','preferredquality':'128'}],'force_generic_extractor':False,'allow_unplayable_formats':True,'source_address':'0.0.0.0','geo_bypass':True,'ignoreerrors':True}
